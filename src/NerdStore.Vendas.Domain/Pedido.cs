...
namespace NerdStore.Vendas.Domain
{
    public class Pedido : Entity, IAggregateRoot
    {
        ...
        //Trata-se de uma uma lista privada, onde só a própria classe poderá alterá-la
        private readonly List<PedidoItem> _pedidoItems;

        //Esta é a lista que será exposta, não permitindo alterações, mantendo assim sua consistência
        ...
        //Construtor utilizado pelo EF
        protected Pedido()
        {
            //Garante que na criação da entidade pelo EF esta lista não fique nula, causando NullReferenceException
            _pedidoItems = new List<PedidoItem>();
        }
